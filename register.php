            ...
            <form class="form" method="" action="">
              <div class="card card-login card-hidden">
                ...
                <div class="card-body">
                  ...
                  <span class="bmd-form-group">
                    <div class="input-group">
                      ...
                      <input type="email" class="form-control" name="email" value="" placeholder="Correo electronico">
                    </div>
                  </span>
                ...
                <div class=" card-footer justify-content-center text-center">
                  <input type="submit"  class="btn btn-rose btn-link btn-lg" name='submit' value='Registrate'></input>
